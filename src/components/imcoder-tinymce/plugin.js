...
const plugins = [
  "advlist anchor autolink autosave code codesample directionality emoticons fullscreen hr image insertdatetime link lists " +
    "media nonbreaking noneditable pagebreak paste preview print save searchreplace tabfocus table template visualblocks visualchars wordcount " +
    "textpattern help autoresize"
];

export { contentStyle, plugins };
